...
function module:AnimeFightersSimulator()
	...
	UIGradient_6.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(0.49, Color3.fromRGB(255, 179, 2)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 128, 8))}
	UIGradient_6.Parent = Devider
	...
	UIGradient_7.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 170, 0))}
	UIGradient_7.Parent = PageName
	...
	UIGradient_8.Parent = BackgroundButton_5
	...
	BackgroundButton_6.Parent = destroyhub
	...
	UIGradient_10.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(0.49, Color3.fromRGB(255, 179, 2)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 128, 8))}
	UIGradient_10.Parent = Devider_2
	...
	UIGradient_11.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 170, 0))}
	UIGradient_11.Parent = PageName_2
	...
	BackgroundButton_7.Parent = resetchar
	...
	UIGradient_12.Parent = BackgroundButton_7
	...
	UIGradient_13.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(0.49, Color3.fromRGB(255, 179, 2)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 128, 8))}
	UIGradient_13.Parent = Devider_3
	...
	UIGradient_14.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 170, 0))}
	UIGradient_14.Parent = PageName_3
	...
	UIGradient_15.Parent = BackgroundButton_8
	...
	UIGradient_16.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(0.49, Color3.fromRGB(255, 179, 2)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 128, 8))}
	UIGradient_16.Parent = Devider_4
	...
	UIGradient_17.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 128, 8)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 170, 0))}
	UIGradient_17.Parent = PageName_4
	...
	local function CSSGCUM_fake_script() -- HubName.Animation 
	...
	coroutine.wrap(CSSGCUM_fake_script)()
	local function HTZPM_fake_script() -- AnimeFightersSimulator.Main 
	...
	coroutine.wrap(HTZPM_fake_script)()
	local function KEVMGLC_fake_script() -- AnimeFightersSimulator.ButtonEffects 
		local script = Instance.new('LocalScript', AnimeFightersSimulator)
	...
	coroutine.wrap(KEVMGLC_fake_script)()
	local function ALXRD_fake_script() -- Devider.Animation 
	...
	coroutine.wrap(ALXRD_fake_script)()
	local function WZOHE_fake_script() -- Devider_2.Animation 
	...
	coroutine.wrap(WZOHE_fake_script)()
	local function DAON_fake_script() -- Devider_3.Animation 
	...
	coroutine.wrap(DAON_fake_script)()
	local function TJIJ_fake_script() -- Devider_4.Animation 
	...
	coroutine.wrap(TJIJ_fake_script)()
end
